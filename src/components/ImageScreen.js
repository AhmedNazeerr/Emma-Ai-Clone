          ...
          <View style={{ flexDirection: "column", flex: 1 }}>
            <View style={styles.messageInput}>
              <TextInput
                ...
                placeholderTextColor={COLORS.darkestLight}
                numberOfLines={3}
                onChangeText={(text) => {
            ...
            <View style={styles.imageContainer}>
              {isLoading ? (
                <ActivityIndicator size='large' color={COLORS.black} style={[styles.loadingIndicator, { opacity: 1 }]} />
              )
                  ...
                  <>
                    {imageURL && (
                      <>
                        ...
                        >
                          <Entypo name="download" size={35} color={COLORS.black} />
                        </TouchableOpacity>
                      </>
                    )}
                  </>
...
const styles = StyleSheet.create({
  ...
  textInput: {
    ...
    height: 40,
    borderRadius: 16,
    borderColor: COLORS.darkestLight,
    borderWidth: 1,
    paddingHorizontal: 20,
    minHeight: 43,
    color: COLORS.black,
